define('homeController', ['app', 'Uploader', 'UploadVideoCover', 'factories', 'less', 'css'], function(app, Uploader, UploadVideoCover){
  'use strict';

  require(['less!homeStyle', 'css!ngDropdownStyle']);
